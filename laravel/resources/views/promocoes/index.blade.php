        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Promocoes</div>
                    <div class="panel-body">
                        <a href="{{ url('/promocoes/create') }}" class="btn btn-success btn-sm" title="Add New promoco">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/promocoes', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
