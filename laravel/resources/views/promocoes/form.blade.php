<div class="form-group {{ $errors->has('nome') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::input('datetime-local', 'inicio', (isset($promoco) && !is_null($promoco->inicio)) ? $promoco->inicio->format('Y-m-d\TH:i:s') : null, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::input('datetime-local', 'fim', (isset($promoco) && !is_null($promoco->fim)) ? $promoco->fim->format('Y-m-d\TH:i:s') : null, ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        {!! Form::select('tipo', ['fixo' => 'Fixo', 'percentual' => 'Percentual'], null, ['class' => 'form-control']) !!}
